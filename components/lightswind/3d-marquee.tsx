  ...
  return (
    <section
      ...
      style={{
        ...
        WebkitMaskComposite: "source-in", // Required for Chrome/Safari
      }}
    >
      <div
                  ...
                  return (
                    <div key={`img-${imgIdx}`} className="relative">
                      ...
                      <motion.img
                        ...
                        className={`aspect-[970/700] w-full max-w-[200px] rounded-lg object-cover shadow-xl hover:shadow-2xl transition-shadow duration-300 ${
