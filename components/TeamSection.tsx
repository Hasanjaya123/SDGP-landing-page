...
const team: TeamMember[] = [
	{
		...
		socials: {
			linkedin: 'https://www.linkedin.com/in/hasanjaya-perera-297720244/?originalSubdomain=lk',
			twitter: '#',
		},
	},
	{
	...
	},
	{
		...
		imageUrl: '/images/senanayake.jpg',
		socials: { linkedin: '#' },
	},
	{
		id: '5',
		...
		imageUrl: '/images/kariyawasam.jpg',
		socials: { linkedin: '#' },
	},
	{
		id: '6',
...
export const TeamSection: React.FC = () => {
	return (
		<section
			id="team"
			className="py-24 bg-gradient-to-br from-indigo-950 via-brand-dark to-indigo-950 text-white relative"
		>
			{/* Background Pattern */}
			<div
			...
			<div className="container mx-auto px-6 relative z-10">
				<div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
					<div className="max-w-2xl">
						...
						<h2 className="text-3xl md:text-5xl font-serif font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">
							The Team behind the project
						</h2>
					</div>
					<p className="text-gray-400 max-w-md text-sm leading-relaxed border-l-2 border-brand-orange pl-4">
						Our team of 6 combines deep knowledge in the sri lankan art market with technical expertise in AI and
						immersive media.
					</p>
				</div>
				...
				<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mx-auto">
					{team.map((member) => (
						<div
							key={member.id}
							className="group relative overflow-hidden rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all hover:-translate-y-2 duration-300 shadow-lg"
						>
							...
							<div className="p-4">
								<h3
									className="text-sm font-serif font-bold mb-1 truncate text-white"
									title={member.name}
								>
									{member.name}
								</h3>
								<p
									className="text-brand-orange text-[9px] font-bold uppercase tracking-wide mb-2 truncate"
									title={member.role}
								>
									{member.role}
								</p>
								<p className="text-gray-400 text-[10px] leading-relaxed mb-3 line-clamp-3 group-hover:text-gray-200 transition-colors">
									{member.bio}
								</p>
